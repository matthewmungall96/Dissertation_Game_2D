...
{
    public GameObject SpectroFightUi;
    public Image SpectroHealthBar;
    public Animator SpectroAnim;
    ...
    void Update()
    {
        ...
        updateHealth();
        if (Boss_Health.SpectroHealth <= 0 && death == false)
        {
            KillSelf();
        }
    ...
    {
        float ratio = Boss_Health.SpectroHealth / Boss_Health.SpectroMaxHealth;
        SpectroHealthBar.rectTransform.localScale = new Vector3(ratio, 1, 1);
    }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.CompareTag("Missile"))
        {
            ...
            Boss_Health.SpectroHealth = Boss_Health.SpectroHealth - 10;
    ...
    private void KillSelf()
    {
        ...
        SpectroAnim.SetBool("Die", true);
        SpectroFightUi.SetActive(false);
    }
}
